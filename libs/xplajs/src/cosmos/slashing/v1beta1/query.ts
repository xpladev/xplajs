...
export const QuerySigningInfoResponse = {
  ...
  is(o: any): o is QuerySigningInfoResponse {
    return o && (o.$typeUrl === QuerySigningInfoResponse.typeUrl || ValidatorSigningInfo.is(o.val_signing_info));
  },
  ...
  fromAmino(object: QuerySigningInfoResponseAmino): QuerySigningInfoResponse {
    ...
    if (object.val_signing_info !== undefined && object.val_signing_info !== null) {
      message.val_signing_info = ValidatorSigningInfo.fromAmino(object.val_signing_info);
    }
    return message;
  },
  toAmino(message: QuerySigningInfoResponse): QuerySigningInfoResponseAmino {
    const obj: any = {};
    obj.val_signing_info = message.val_signing_info ? ValidatorSigningInfo.toAmino(message.val_signing_info) : ValidatorSigningInfo.toAmino(ValidatorSigningInfo.fromPartial({}));
    return obj;
  },

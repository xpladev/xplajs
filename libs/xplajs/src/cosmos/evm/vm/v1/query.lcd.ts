...
export class LCDQueryClient {
  ...
  account = async (params: QueryAccountRequest): Promise<QueryAccountResponse> => {
    const endpoint = `cosmos/evm/vm/v1/account/${params.address}`;
  ...
  cosmosAccount = async (params: QueryCosmosAccountRequest): Promise<QueryCosmosAccountResponse> => {
    const endpoint = `cosmos/evm/vm/v1/cosmos_account/${params.address}`;
  ...
  validatorAccount = async (params: QueryValidatorAccountRequest): Promise<QueryValidatorAccountResponse> => {
    const endpoint = `cosmos/evm/vm/v1/validator_account/${params.consAddress}`;
  ...
  balance = async (params: QueryBalanceRequest): Promise<QueryBalanceResponse> => {
    const endpoint = `cosmos/evm/vm/v1/balances/${params.address}`;
  ...
  storage = async (params: QueryStorageRequest): Promise<QueryStorageResponse> => {
    const endpoint = `cosmos/evm/vm/v1/storage/${params.address}/${params.key}`;
  ...
  traceTx = async (params: QueryTraceTxRequest): Promise<QueryTraceTxResponse> => {
    ...
    const endpoint = `cosmos/evm/vm/v1/trace_tx`;
  ...
  baseFee = async (_params: QueryBaseFeeRequest = {}): Promise<QueryBaseFeeResponse> => {
    const endpoint = `cosmos/evm/vm/v1/base_fee`;
    return await this.req.get<QueryBaseFeeResponse>(endpoint);
  };
  /* Config queries the EVM configuration */
  config = async (_params: QueryConfigRequest = {}): Promise<QueryConfigResponse> => {
    const endpoint = `cosmos/evm/vm/v1/config`;
  ...
  globalMinGasPrice = async (_params: QueryGlobalMinGasPriceRequest = {}): Promise<QueryGlobalMinGasPriceResponse> => {
    const endpoint = `cosmos/evm/vm/v1/min_gas_price`;
    return await this.req.get<QueryGlobalMinGasPriceResponse>(endpoint);
  };
}
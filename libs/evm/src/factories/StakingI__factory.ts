...
import type { StakingI, StakingIInterface } from "../StakingI";
...
export class StakingI__factory {
  static readonly abi = _abi;
  static createInterface(): StakingIInterface {
    return new Interface(_abi) as StakingIInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): StakingI {
    return new Contract(address, _abi, runner) as unknown as StakingI;
  }
}

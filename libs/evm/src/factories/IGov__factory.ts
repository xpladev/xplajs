...
export class IGov__factory {
  ...
  static createInterface(): IGovInterface {
    return new Interface(_abi) as IGovInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IGov {
    return new Contract(address, _abi, runner) as unknown as IGov;
  }
}

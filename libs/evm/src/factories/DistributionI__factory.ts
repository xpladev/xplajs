...
import type { DistributionI, DistributionIInterface } from "../DistributionI";
...
export class DistributionI__factory {
  static readonly abi = _abi;
  static createInterface(): DistributionIInterface {
    return new Interface(_abi) as DistributionIInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): DistributionI {
    return new Contract(address, _abi, runner) as unknown as DistributionI;
  }
}

...
export class Gov__factory {
  static readonly abi = _abi;
  static createInterface(): GovInterface {
    return new Interface(_abi) as GovInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Gov {
    return new Contract(address, _abi, runner) as unknown as Gov;
  }
}

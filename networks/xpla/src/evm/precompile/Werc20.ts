...
export interface Werc20Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface Werc20 extends BaseContract {
  connect(runner?: ContractRunner | null): Werc20;
  waitForDeployment(): Promise<this>;

  interface: Werc20Interface;

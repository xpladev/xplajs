...
export interface Staking extends BaseContract {
  ...
  allowance: TypedContractMethod<
    [grantee: AddressLike, granter: AddressLike, method: string],
    [bigint],
    "view"
  >;

  approve: TypedContractMethod<
    [grantee: AddressLike, amount: BigNumberish, methods: string[]],
    [boolean],
    "nonpayable"
  >;
  ...
  revoke: TypedContractMethod<
    [grantee: AddressLike, methods: string[]],
    [boolean],
    "nonpayable"
  >;
  ...
  getEvent(
    ...
    AllowanceChangeEvent.InputTuple,
    AllowanceChangeEvent.OutputTuple,
    AllowanceChangeEvent.OutputObject
  >;
  getEvent(
    key: "Approval"
  ): TypedContractEvent<
  ...
  filters: {
    "AllowanceChange(address,address,string[],uint256[])": TypedContractEvent<
      AllowanceChangeEvent.InputTuple,
      AllowanceChangeEvent.OutputTuple,
      AllowanceChangeEvent.OutputObject
    >;
    AllowanceChange: TypedContractEvent<
      AllowanceChangeEvent.InputTuple,
      AllowanceChangeEvent.OutputTuple,
      AllowanceChangeEvent.OutputObject
    >;

    "Approval(address,address,string[],uint256)": TypedContractEvent<
      ApprovalEvent.InputTuple,
      ApprovalEvent.OutputTuple,
      ApprovalEvent.OutputObject
    >;
    ...
    "Revocation(address,address,string[])": TypedContractEvent<
      RevocationEvent.InputTuple,
      RevocationEvent.OutputTuple,
      RevocationEvent.OutputObject
    >;
